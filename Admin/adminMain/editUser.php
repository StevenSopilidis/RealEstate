...
<body>
    ...
    <div id="vue-app">
        ...
        <div id="users">
                ...
                <tbody id="tablebody">
                    <tr>
                        <?php
                            ...
                            $result = $userview->getUsers($usersDisplayed);
                            for ($i=0; $i < sizeof($result); $i++) { 
                                ...
                                echo "
                                    <tr>
                                        ...
                                        <td>$lastname</td>
                                        <td>$email</td>
                                        <td><button data-userid='$id' id='editBtn' class='btn btn-warning'>Edit</button></td>
                                        <td><button data-userid='$id' id='deleteBtn' class='btn btn-danger'>Delete</button></td>
                                    </tr>
                                ";
                            }
                        ?>
            ...
            <form>
                <button v-on:click.prevent="seeMoreUsers" class="btn btn-info">See More</button>
            </form>
