...
<body>
    ...
    <div id="vue-app">
        ...
        <form style="width: 70%; margin: 0 auto; margin-top: 40px;" action="createUser.act.php" v-bind:class="validate" method="post" id="registerForm">
                ...
                <button v-on:click.prevent="registerUser" style="margin-left: 30%; margin-top: 40px" class="btn btn-success col-4">Add User</button>
            </form>
    </div>
