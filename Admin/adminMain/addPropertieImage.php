...
<body>
    <div id="vue-app">
        ...
        <h5 style="margin-left: 3rem" id="main_heading">Site Administrator</h5>
        <h6 style="margin-left: 3rem">Add Image for Propertie</h6>

        <form action=<?php echo "uploadPropertieImage.php?propId=$_SESSION[prop_id]" ?> style="margin-left: 2rem; margin-top: 2rem" enctype="multipart/form-data" method="post">
            ...
            <button name="uploadImage" style="margin-left: 1rem" class="btn btn-info">Upload</button>
        </form>
